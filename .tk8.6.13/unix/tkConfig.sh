...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/karel/.tk8.6.13/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/karel/.local_tcltk/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/karel/.local_tcltk/include'
...
# compiled.
TK_SRC_DIR='/home/karel/.tk8.6.13'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/karel/.tk8.6.13/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/karel/.local_tcltk/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/karel/.tk8.6.13/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/karel/.local_tcltk/lib/libtkstub8.6.a'
